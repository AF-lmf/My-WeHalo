...
Page({
    ...
    successComment: function (res, selfObj) {
        ...
        for (let i = 0; i < list.length; ++i) {
            ...
            if (list[i].isAdmin) {
                list[i].email = '';
                list[i].authorUrl = 'https://lmf618-1256679305.cos.ap-beijing.myqcloud.com/u=1114760231,1726272748&fm=26&gp=0_1577607946273.jpg';
            }
        }
    ...
    CommentSubmit: function (e) {
        ...
        if (!that.data.CommentContent) {
            ...
            var params = {
                ...
                //authorUrl: app.globalData.userInfo.country+app.globalData.userInfo.province+,
                content: that.data.CommentContent,
                email: "lmf61888@126.com",
                parentId: 0,
